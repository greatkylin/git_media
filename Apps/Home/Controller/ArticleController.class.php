...
class ArticleController extends HomeBaseController
{
    ...
    private function detail_common_content(){
        ...
        //设置seo信息
        $this->setSiteSeoInfo($article['title'], $article['keywords'], $article['description']);
        //文章内容中图片路径的替换
        ...
        //判断是否是预览，是则不增加流览量
        $isPreview = intval(I('preview'));
        $articleService->updateArticleClickNum($articleId, $isPreview);
